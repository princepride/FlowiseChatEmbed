    ...
    create(context) {
        ...
        const checkForTrackedScopes = (node) => {
            ...
            if (node.type === "JSXExpressionContainer") {
                ...
                else if (((_d = node.parent) === null || _d === void 0 ? void 0 : _d.type) === "JSXAttribute" &&
                    node.parent.name.name === "value" &&
                    ((_e = node.parent.parent) === null || _e === void 0 ? void 0 : _e.type) === "JSXOpeningElement" &&
                    ((node.parent.parent.name.type === "JSXIdentifier" &&
                ...
                else if (((_f = node.parent) === null || _f === void 0 ? void 0 : _f.type) === "JSXAttribute" &&
                    ((_g = node.parent.name) === null || _g === void 0 ? void 0 : _g.type) === "JSXIdentifier" &&
                    /^static[A-Z]/.test(node.parent.name.name) &&
                    ((_h = node.parent.parent) === null || _h === void 0 ? void 0 : _h.type) === "JSXOpeningElement" &&
                    node.parent.parent.name.type === "JSXIdentifier" &&
                    !(0, utils_2.isDOMElementName)(node.parent.parent.name.name)) {
                }
                else if (((_j = node.parent) === null || _j === void 0 ? void 0 : _j.type) === "JSXAttribute" &&
                    node.parent.name.name === "ref" &&
                    (0, utils_2.isFunctionNode)(node.expression)) {
                    pushTrackedScope(node.expression, "called-function");
                }
                else if (((_k = node.parent) === null || _k === void 0 ? void 0 : _k.type) === "JSXElement" && (0, utils_2.isFunctionNode)(node.expression)) {
                        ...
                        if (arg0) {
                            if (arg0.type === "ArrayExpression") {
                                arg0.elements.forEach((element) => {
                                    if (element && (element === null || element === void 0 ? void 0 : element.type) !== "SpreadElement") {
                        ...
                        if (arg1) {
                            ...
                            if (owner) {
                                ...
                                if (decl &&
                                    ...
                                    ((_l = decl.node.init) === null || _l === void 0 ? void 0 : _l.type) === "CallExpression" &&
                ...
                if (((_m = node.init) === null || _m === void 0 ? void 0 : _m.type) === "CallExpression" && node.init.callee.type === "Identifier") {
                        ...
                        if (track) {
                            for (const reference of track.references) {
                                if (!reference.init &&
                                    ...
                                    ((_o = reference.identifier.parent) === null || _o === void 0 ? void 0 : _o.type) === "CallExpression" &&
